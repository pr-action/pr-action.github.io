The different tools and sub-tools used by KhulnaSoft PR-Action are adjustable via the **[configuration file](https://github.com/Pr-action/pr-action/blob/main/pr_action/settings/configuration.toml)**.
