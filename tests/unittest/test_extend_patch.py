...
class TestExtendPatch:
    ...
    def test_single_hunk(self):
        ...
        for num_lines in [
            ...
            2,
            3,
        ]:  # check that even if we are over the number of lines in the file, the function still works
            expected_output = "\n@@ -1,5 +1,5 @@ init()\n line1\n-line2\n+new_line2\n line3\n line4\n line5"
            actual_output = extend_patch(
                original_file_str,
                patch_str,
...
class TestExtendedPatchMoreLines:
    ...
    def test_extend_patches_with_extra_lines(self, token_handler, pr_languages):
        (
            patches_extended_no_extra_lines,
            total_tokens,
        ...
        (
            patches_extended_with_extra_lines,
            total_tokens,
            patches_extended_tokens,
        ) = pr_generate_extended_diff(
            pr_languages,
