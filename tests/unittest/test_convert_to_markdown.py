...
from pr_action.algo.utils import PRReviewHeader, convert_to_markdown_v2
...
class TestConvertToMarkdown:
    ...
    def test_simple_dictionary_input(self):
        input_data = {
            ...
            "code_feedback": [
                {
                    "relevant_file": "``pr_action/git_providers/git_provider.py\n``",
                    "language": "python\n",
                    ...
                    "relevant_line": '[return ""](https://github.com/KhulnaSoft/pr-action-pro/pull/102/files#diff-52d45f12b836f77ed1aef86e972e65404634ea4e2a6083fb71a9b0f9bb9e062fR199)',
                }
            ],
        }

        expected_output = f"{PRReviewHeader.REGULAR.value} 🔍\n\n<table>\n<tr><td>⏱️&nbsp;<strong>Estimated effort to review</strong>: 1 🔵⚪⚪⚪⚪</td></tr>\n<tr><td>🧪&nbsp;<strong>No relevant tests</strong></td></tr>\n<tr><td>⚡&nbsp;<strong>Possible issues</strong>: No\n</td></tr>\n<tr><td>🔒&nbsp;<strong>No security concerns identified</strong></td></tr>\n</table>\n\n\n<details><summary> <strong>Code feedback:</strong></summary>\n\n<hr><table><tr><td>relevant file</td><td>pr_action/git_providers/git_provider.py\n</td></tr><tr><td>suggestion &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>\n\n<strong>\n\nConsider raising an exception or logging a warning when 'pr_url' attribute is not found. This can help in debugging issues related to the absence of 'pr_url' in instances where it's expected. [important]\n\n</strong>\n</td></tr><tr><td>relevant line</td><td><a href='https://github.com/KhulnaSoft/pr-action-pro/pull/102/files#diff-52d45f12b836f77ed1aef86e972e65404634ea4e2a6083fb71a9b0f9bb9e062fR199'>return \"\"</a></td></tr></table><hr>\n\n</details>"
