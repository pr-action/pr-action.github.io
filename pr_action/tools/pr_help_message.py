...
from pr_action.algo.pr_processing import retry_with_fallback_models
from pr_action.algo.token_handler import TokenHandler
from pr_action.algo.utils import ModelType, load_yaml
from pr_action.config_loader import get_settings
from pr_action.git_providers import get_git_provider, GithubProvider, BitbucketServerProvider, \
    ...
    async def run(self):
        try:
            if self.question_str:
                ...
                base_path = "https://pr-action.github.io/tools"
                ...
                if isinstance(self.git_provider, GithubProvider) and not get_settings().config.get('disable_checkboxes', False):
                    ...
                    pr_comment += "</table>\n\n"
                    pr_comment += f"""\n\n(1) Note that each tool be [triggered automatically](https://pr-action.github.io/usage-guide/automations_and_usage/#github-app-automatic-tools-when-a-new-pr-is-opened) when a new PR is opened, or called manually by [commenting on a PR](https://pr-action.github.io/usage-guide/automations_and_usage/#online-usage)."""
                    ...
                    pr_comment += "</table>\n\n"
                    pr_comment += f"""\n\nNote that each tool be [invoked automatically](https://pr-action.github.io/usage-guide/automations_and_usage/) when a new PR is opened, or called manually by [commenting on a PR](https://pr-action.github.io/usage-guide/automations_and_usage/#online-usage)."""
