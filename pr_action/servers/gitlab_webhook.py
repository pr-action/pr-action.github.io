...
async def _perform_commands_gitlab(commands_conf: str, agent: PRAction, api_url: str,
                                   log_context: dict):
...
async def gitlab_webhook(background_tasks: BackgroundTasks, request: Request):
    ...
    async def inner(data: dict):
        ...
        if data.get('object_kind') == 'merge_request' and data['object_attributes'].get('action') in ['open', 'reopen']:
            ...
            await _perform_commands_gitlab("pr_commands", PRAction(), url, log_context)
            ...
            try:
                ...
                await _perform_commands_gitlab("push_commands", PRAction(), url, log_context)
            except Exception as e:
