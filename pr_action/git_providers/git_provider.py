...
class GitProvider(ABC):
    ...
    def get_user_description(self) -> str:
        ...
        if not self._is_generated_by_pr_action(description_lowercase):
            get_logger().info(
                f"Existing description was not generated by the pr-action"
            )
        ...
        if user_description_header not in description_lowercase:
            get_logger().info(
                f"Existing description was generated by the pr-action, but it doesn't contain a user description"
            )
            return ""
