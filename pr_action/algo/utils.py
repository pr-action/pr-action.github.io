...
def get_max_tokens(model):
    ...
    if model in MAX_TOKENS:
        ...
        raise Exception(f"Ensure {model} is defined in MAX_TOKENS in ./pr_action/algo/__init__.py or set a positive value for it in config.custom_model_max_tokens")
